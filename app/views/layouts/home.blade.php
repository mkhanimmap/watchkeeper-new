...
<head>
    ...
    {{ HTML::style("css/bower_components/bootstrap/dist/css/bootstrap-cosmo.css") }}
    ...
    {{ HTML::style("css/immap-home.css") }}
    {{ HTML::style("css/immap-home-cosmo.css") }}
...
<body>
    <div class="header">
        <div class="headerinner">
            <div class="oasislogo">
                {{ HTML::decode(link_to('/', HTML::image('css/images/logoimmap.png', 'IMMAP - Because Infomation Matters'))) }}
            </div>
        </div>
    </div>
