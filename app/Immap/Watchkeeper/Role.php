...
class Role extends Eloquent {
    ...
    {
        return $this->belongsToMany('\Immap\Watchkeeper\User', 'assigned_roles')->withTimestamps();;
    }
    ...
    public function perms()
    {
        ...
        try
        {
            return $this->belongsToMany('\Immap\Watchkeeper\Permission','permission_roles')->withTimestamps();;
        }
        catch(Execption $e) {}
    }
    ...
    */
    public function beforeDelete( $forced = false )
    {
        try
        {
            ...
            \DB::table('permission_roles')->where('role_id', $this->id)->delete();
        } catch(Execption $e) {}
